...
export const translations = {
  zh: {
    ...
    student: {
      ...
      gradeBreakdown: '成绩构成',
      assignmentList: '作业列表',
      noClassesToday: '今天没有课程，好好利用这段时间！',
      noEventsOfThisType: '暂无该类型的活动',
      mscHealthDataScience: '健康数据科学硕士',
      year1: '一年级',
      addSchedule: '添加日程',
      ...
      scheduleAddedSuccessfully: '日程添加成功！',
      course: '课程',
      meeting: '会议',
      lab: '实验',
      seminar: '研讨',
      ...
      addSchedule: '添加日程',
      health: '健康',
      campusHealthServices: '校园健康服务',
      oneTapConsult: '一键问诊',
      contactRemoteDoctor: '联系远程医生',
      bookOnSiteVisit: '预约面诊',
      bookNow: '立即预约',
      psychologicalAssessment: '心理评估',
      allergyTesting: '过敏检测',
      physicalCheckUp: '身体检查',
      generalConsultation: '综合问诊',
      myReports: '我的报告',
      visitHistory: '就诊历史',
      prescriptions: '处方记录',
    },
  ...
  en: {
    ...
    student: {
      ...
      noEventsOfThisType: 'No events of this type',
      mscHealthDataScience: 'MSc Health Data Science',
      year1: 'Year 1',
      ...
      addSchedule: 'Add Schedule',
      health: 'Health',
      campusHealthServices: 'Campus Health Services',
      oneTapConsult: 'One-tap consult',
      contactRemoteDoctor: 'Contact remote doctor',
      bookOnSiteVisit: 'Book on-site visit',
      bookNow: 'Book now',
